...
impl Command for CloneCommand {
    fn execute(&self) -> Result<()> {
        ...
        let repo_details = github::get_repo_details(&owner, &repo_name)?;
...
fn should_add_upstream(owner: &str, repo_details: &github::GetRepoResponse) -> Result<bool> {
